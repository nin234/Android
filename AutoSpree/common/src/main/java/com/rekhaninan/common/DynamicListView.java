...
public class DynamicListView extends ListView {
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        ArrayAdapterMainVw adapter = ((ArrayAdapterMainVw)getAdapter());
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            ArrayAdapterMainVw adapterMainVw = (ArrayAdapterMainVw) getAdapter();
            adapterMainVw.moveElements(originalItem, getPositionForView(switchView));
