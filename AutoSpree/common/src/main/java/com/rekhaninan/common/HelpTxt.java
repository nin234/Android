...
public class HelpTxt {
    ...
    public static final String EasyGrocTxt = "Create Planner lists. Click planner tab in the bottom tab bar to " +
            ...
            public static final String NShareListTxt = "Create Template lists. Click Templates icon in the" +
                    ...
                    " template item on the screen.\nAdd items to the list. Click the Edit button on top right " +
                    ...
                    "The newly created list will have all the items in the off position (switch red color). " +
                    "Once a check list task or item is accomplished the switch can be changed to the On position " +
                    "(green color).\n\nClicking the brand new list on this screen will create an empty blank list. " +
                    "This can be used for one time lists or tasks.\n\nThe check list can be shared with friends. " +
                    "Notifications should be enabled for the app for sharing. Notifications can be enabled during " +
                    "intial start up or later in the Settings app.\n\n The first step to share is to add Contacts " +
                    ...
                    "click the Recipients icon on the top right corner. This will bring up the Contacts screen. " +
                    "Select the contacts to share the item. Once the contacts are selected click the Send button. " +
                    "This will sent the list to the selected Contacts";
